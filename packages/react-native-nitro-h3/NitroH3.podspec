...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/vgorte/react-native-nitro-h3"
  s.license      = { :type => package["license"], :file => "LICENSE" }
  s.authors      = package["author"] || "react-native-nitro-h3 contributors"
  s.platforms    = { :ios => min_ios_version_supported }  # <-- inherited, never pinned
  s.source       = { :git => "https://github.com/vgorte/react-native-nitro-h3.git", :tag => "#{s.version}" }
