 ...
 *
 * These stay separate types from H3's own `::LatLng` and `::CoordIJ`. `::LatLng` carries radians,
 * so that a unit mix-up is a compile error rather than an answer wrong by a factor of 57.
 */
namespace h3core {
