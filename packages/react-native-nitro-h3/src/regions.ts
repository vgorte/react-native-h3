 ...
 * would exceed a cell ceiling set with {@linkcode configure}. With a ceiling set, the call is
 * refused before any work whenever the bounding-box estimate of {@linkcode polygonToCells} already
 * exceeds it.
 */
